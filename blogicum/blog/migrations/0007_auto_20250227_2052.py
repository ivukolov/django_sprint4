# Generated by Django 3.2.16 on 2025-02-27 17:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='blog.post', verbose_name='Комменатрий к посту'),
        ),
        migrations.AlterField(
            model_name='post',
            name='author',
